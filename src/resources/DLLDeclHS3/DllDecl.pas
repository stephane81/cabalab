...
type  ERROR      = word;
      ...
      *}
      ...
      TADC_GetDataCh             = function( wCh  : word;     wData : PTWArray                            ) : ERROR; stdcall;
      TADC_GetDataVoltCh         = function( wCh  : word;     dData : PTDArray                            ) : ERROR; stdcall;
     {*
...
function _DefineUSB  (hHandle: THandle): LongInt  ;



var   Ch3DoubleArray            : DArray;
