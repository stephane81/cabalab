...
uses  PrincipalOscilloCaba,regressispecdecl;    //permet la liason avec les varaibles de principal
{$R *.dfm}
...
begin
    ...
    if principalOscilloCaba.courbes[1].Valide  = true then begin GroupBoxEnrg1.Visible:=true; CheckBoxEnregistrement1.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[1].long_ech) +' pts' end;
    if principalOscilloCaba.courbes[2].Valide  = true then begin GroupBoxEnrg2.Visible:=true; CheckBoxEnregistrement2.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[2].long_ech) +' pts' end;
    if principalOscilloCaba.courbes[3].Valide  = true then begin GroupBoxEnrg3.Visible:=true; CheckBoxEnregistrement3.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[3].long_ech) +' pts' end;
    if principalOscilloCaba.courbes[4].Valide  = true then begin GroupBoxEnrg4.Visible:=true; CheckBoxEnregistrement4.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[4].long_ech) +' pts' end;
    if principalOscilloCaba.courbes[5].Valide  = true then begin GroupBoxEnrg5.Visible:=true; CheckBoxEnregistrement5.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[5].long_ech) +' pts' end;
    if principalOscilloCaba.courbes[6].Valide  = true then begin GroupBoxEnrg6.Visible:=true; CheckBoxEnregistrement6.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[6].long_ech) +' pts' end;
    if principalOscilloCaba.courbes[7].Valide  = true then begin GroupBoxEnrg7.Visible:=true; CheckBoxEnregistrement7.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[7].long_ech) +' pts' end;
    if principalOscilloCaba.courbes[8].Valide  = true then begin GroupBoxEnrg8.Visible:=true; CheckBoxEnregistrement8.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[8].long_ech) +' pts' end;
    if principalOscilloCaba.courbes[9].Valide  = true then begin GroupBoxEnrg9.Visible:=true; CheckBoxEnregistrement9.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[9].long_ech) +' pts' end;
    if principalOscilloCaba.courbes[10].Valide = true then begin GroupBoxEnrg10.Visible:=true; CheckBoxEnregistrement10.caption:='Nb de points dispo. : '+floattostr(principalOscilloCaba.courbes[10].long_ech) +' pts' end;

    if principalOscilloCaba.courbes[1].Valide  = true then begin  CheckBox1.Visible:=true end;
    if principalOscilloCaba.courbes[2].Valide  = true then begin  CheckBox2.Visible:=true end;
    if principalOscilloCaba.courbes[3].Valide  = true then begin  CheckBox3.Visible:=true end;
    if principalOscilloCaba.courbes[4].Valide  = true then begin  CheckBox4.Visible:=true end;
    if principalOscilloCaba.courbes[5].Valide  = true then begin  CheckBox5.Visible:=true end;
    if principalOscilloCaba.courbes[6].Valide  = true then begin  CheckBox6.Visible:=true end;
    if principalOscilloCaba.courbes[7].Valide  = true then begin  CheckBox7.Visible:=true end;
    if principalOscilloCaba.courbes[8].Valide  = true then begin  CheckBox8.Visible:=true end;
    if principalOscilloCaba.courbes[9].Valide  = true then begin  CheckBox9.Visible:=true end;
    if principalOscilloCaba.courbes[10].Valide = true then begin  CheckBox10.Visible:=true end;
