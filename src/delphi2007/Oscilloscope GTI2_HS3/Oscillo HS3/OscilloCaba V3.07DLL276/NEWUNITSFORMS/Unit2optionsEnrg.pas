...
Longueur_Acquisition := principalOscillocaba.courbes [principalOscillocaba.courbe_options].long_ech;
Calibre1             := principalOscillocaba.courbes [principalOscillocaba.courbe_options].calibCh1_ech;
Calibre2             := principalOscillocaba.courbes [principalOscillocaba.courbe_options].calibCh2_ech;
...
// Affichage Voie 1
   if ((PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].mode=ch1) or (PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].mode=chop)) and (sender=paintbox1) then
      begin
          // GroupBoxCH1.visible:=true;
           LabelCALCH1.caption:= 'Cal CH1 = '+floattostr(PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].calibCh1_ech/4)+' V/div';
        ...
        //   LabelINV1.caption:= Principal.courbes [principal.courbe_options].inv;
           ...
           Sender.Canvas.MoveTo(0, Round(  PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].voie1[ 0 ] * (Sender.Height/2) / Calibre1 + (Sender.Height/2) ));

           for Curseur_Abscisse := 1 to Sender.Width - 1 do
           begin
                Sender.Canvas.Pen.Color :=  PrincipalOscillocaba.courbes [courbe_options].couleur1;
                Curseur_Ordonnee := Round(  -PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].voie1[ round( Curseur_Abscisse * Longueur_Acquisition / Sender.Width ) ] * (Sender.Height/2) / Calibre1 + (Sender.Height/2) );
...
// Affichage Voie 2
   if ((PrincipalOscillocaba.courbes [courbe_options].mode=ch2) or (PrincipalOscillocaba.courbes [courbe_options].mode=chop)) and (sender=paintbox2)then
      begin
           //GroupBoxCH2.visible:=true;
           LabelCALCH2.caption:= 'Cal CH2 = '+floattostr(PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].calibCh2_ech/4)+' V/div';
           ...
           sender.Canvas.MoveTo(0, Round(  -{(invech2)*}PrincipalOscillocaba.courbes [courbe_options].voie2[ 0 ] * (sender.Height/2) / Calibre2 + (sender.Height/2) ));

          for Curseur_Abscisse := 1 to sender.Width - 1 do
          begin

          sender.Canvas.Pen.Color := PrincipalOscillocaba.courbes [courbe_options].couleur2;

          Curseur_Ordonnee := Round(  -{(invech2)*}PrincipalOscillocaba.courbes [courbe_options].voie2[ round( Curseur_Abscisse * Longueur_Acquisition / sender.Width ) ] * (sender.Height/2) / Calibre2 + (sender.Height/2) );
          sender.Canvas.LineTo(Curseur_Abscisse, Curseur_Ordonnee);
          end;

    end;
//affichage XY
    if (PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].XY = true) and (sender=paintbox3) then
    begin
        //GroupBoxXY.visible:=true;
        LabelY.caption:= 'Y = CH2   Cal CH2 = '+floattostr(PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].calibCh2_ech/4)+' V/div';
        LabelX.caption:= 'X = CH1   Cal CH1 = '+floattostr(PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].calibCh1_ech/4)+' V/div';
        // effaçage
        Sender.Canvas.Brush.Color := clBlack;
        Sender.Canvas.Rectangle(0, 0, Sender.Width - 1, Sender.Height - 1);
...
// Affichage Voie XY
    ...
    Sender.Canvas.MoveTo( round((invech1)*Ch1DoubleArray[ 1  ] * (Sender.width/2) / Calibre1 + (Sender.width/2)),round(-(invech2)*Ch2DoubleArray[ 1 ] * (Sender.Height/2) / Calibre2 + (Sender.Height/2)) );
          ...
          Curseur_abscisse := Round(  PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].voie1[ x ] * (Sender.width/2) / Calibre1 + (Sender.width/2) );
          Curseur_Ordonnee := Round(  -PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].voie2[ x ] * (Sender.Height/2) / Calibre2 + (Sender.Height/2) );
...
begin
      ...
      /////modif 3.xxx  TabSheet!
       ...
       for i:=1 to principalOscillocaba.nb_courbes_stockees do
       pages[i].TabVisible:=true;

       PageControl1.TabIndex:=principalOscillocaba.courbe_options -1;
...
begin
   ...
   if principalOscillocaba.courbe_options <> principalOscillocaba.nb_courbes_stockees then
      for i:= principalOscillocaba.courbe_options to principalOscillocaba.nb_courbes_stockees - 1 do
          principalOscillocaba.courbes[i] := principalOscillocaba.courbes[i+1];


principalOscillocaba.nb_courbes_stockees := principalOscillocaba.nb_courbes_stockees - 1 ;
...
principalOscillocaba.courbes[principalOscillocaba.courbe_options].nom := Options.editOptions.text ;
//form1.visible:= true;
...
principalOscillocaba.courbes[principalOscillocaba.courbe_options].couleur1:=colordialog1.color;
...
ColorDialog1.execute;
principalOscillocaba.courbes[principalOscillocaba.courbe_options].couleur2:=colordialog1.color;
Options.visible:=true;
formshow(self);
end;
...
begin
    ...
    principalOscillocaba.courbe_options:=PageControl1.TabIndex +1;
    label1.caption:=floattostr(principalOscillocaba.courbe_options);
    editoptions.text := principalOscillocaba.courbes[principalOscillocaba.courbe_options].nom ;
      GroupBoxCH1.visible:=false;
      GroupBoxCH2.visible:=false;
      GroupBoxXY.visible:=false;

      if PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].mode=ch1 then
      begin
      ...
      if PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].mode=ch2 then
      begin
      ...
      if  PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].mode=chop then
      begin
      ...
      if PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].XY = true then
      begin
     ...
     // Affichage(paintbox2);
      ...
      aC1.checked:=true;
      aC2.checked:=true;
      DC1.checked:=PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].couplageCH1DC;
      DC2.checked:=PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].couplageCH2DC;
      INVch1.checked:=PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].INVCH1;
      INVch2.checked:=PrincipalOscillocaba.courbes [principalOscillocaba.courbe_options].INVCH2;
