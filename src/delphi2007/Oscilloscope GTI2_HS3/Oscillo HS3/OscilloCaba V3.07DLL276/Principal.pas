               ...
               // GroupBoxVch1Mesures.visible:=true;
                ...
                if Aff=true then
                    begin
                          ...
                          begin
                          labelVch1Max.caption:='V1max = ' +floattostrf(Amax1,ffFixed,4,3)+' V';
                          labelVch1Min.caption:='V1min = ' +floattostrf(Amin1,ffFixed,4,3)+' V';
                          labelVch1DC.caption:=  'V1 DC  = ' +floattostrf(vdc1,ffFixed,4,3)+' V';
                          labelVch1AC.caption:=  'V1 AC  = ' +floattostrf(vac1,ffFixed,4,3)+' V';
                          labelVch1ACDC.caption:='V1        = ' +floattostrf(vacdc1,ffFixed,4,3)+' V' + #9'AC+DC';
                          end;
                    end
                 else
                    begin
                          ...
                          labelVch1Max.caption:='V1max = ' +floattostrf(Amax1,ffFixed,4,3)+' V';
                          labelVch1Min.caption:='V1min = ' +floattostrf(Amin1,ffFixed,4,3)+' V';
                          labelVch1DC.caption:=  'V1 DC   ';
                          labelVch1AC.caption:=  'V1 AC   ' ;
                          labelVch1ACDC.caption:='V1        ';
                          end;
                    end;
                ...
                if aff=true then
                    begin
                          ...
                          begin
                          labelVch2Max.caption:='V2max = ' +floattostrf(Amax2,ffFixed,4,3)+' V';
                          labelVch2Min.caption:='V2min = ' +floattostrf(Amin2,ffFixed,4,3)+' V';
                          labelVch2DC.caption:=  'V2 DC  = ' +floattostrf(vdc2,ffFixed,4,3)+' V';
                          labelVch2AC.caption:=  'V2 AC  = ' +floattostrf(vac2,ffFixed,4,3)+' V';
                          labelVch2ACDC.caption:='V2        = ' +floattostrf(vacdc2,ffFixed,4,3)+' V' + #9'AC+DC';
                          end;
                    end
                 else
                    begin
                          ...
                          labelVch2Max.caption:='V2max = ' +floattostrf(Amax2,ffFixed,4,3)+' V';
                          labelVch2Min.caption:='V2min = ' +floattostrf(Amin2,ffFixed,4,3)+' V';
                          labelVch2DC.caption:=  'V2 DC   ';
                          labelVch2AC.caption:=  'V2 AC   ' ;
                          labelVch2ACDC.caption:='V2        ';
                          end;
                    end;
...
begin
    ...
    if calibre10mics.Checked=true then begin REGOSC.frequenceHS3:=50000000; REGOSC.LongEnrgHS3:=5000;  REGOSC.TimeOUTHS3:=1;   ScrollBar5.position:=4; end;
    if calibre20mics.Checked=true then begin REGOSC.frequenceHS3:=50000000; REGOSC.LongEnrgHS3:=10000; REGOSC.TimeOUTHS3:=1;   ScrollBar5.position:=5; end;
    if calibre50mics.Checked=true then begin REGOSC.frequenceHS3:=10000000; REGOSC.LongEnrgHS3:=5000;  REGOSC.TimeOUTHS3:=1;   ScrollBar5.position:=6; end;
    ...
    if calibre1ms.Checked=true    then begin REGOSC.frequenceHS3:=1000000;  REGOSC.LongEnrgHS3:=10000; REGOSC.TimeOUTHS3:=10; ScrollBar5.position:=10;end;
    if calibre2ms.Checked=true    then begin REGOSC.frequenceHS3:=500000;   REGOSC.LongEnrgHS3:=10000; REGOSC.TimeOUTHS3:=20; ScrollBar5.position:=11;end;
    if calibre5ms.Checked=true    then begin REGOSC.frequenceHS3:=200000;   REGOSC.LongEnrgHS3:=10000; REGOSC.TimeOUTHS3:=50; ScrollBar5.position:=12;end;
    if calibre10ms.Checked=true   then begin REGOSC.frequenceHS3:=100000;   REGOSC.LongEnrgHS3:=10000; REGOSC.TimeOUTHS3:=100; ScrollBar5.position:=13;end;
    if calibre20ms.Checked=true   then begin REGOSC.frequenceHS3:=50000;    REGOSC.LongEnrgHS3:=10000; REGOSC.TimeOUTHS3:=200; ScrollBar5.position:=14;end;
...
begin
  if CALIBCH1_20V.Checked=true   then  begin REGOSC.calibreCH1:=20; Calibrech1scrollbar.position:=1; end;
  if CALIBCH1_8V.Checked=true    then  begin REGOSC.calibreCH1:=8;  Calibrech1scrollbar.position:=2; end;
  if CALIBCH1_4V.Checked=true    then  begin REGOSC.calibreCH1:=4;  Calibrech1scrollbar.position:=3; end;
  if CALIBCH1_2V.Checked=true    then  begin REGOSC.calibreCH1:=2;  Calibrech1scrollbar.position:=4; end;
  if CALIBCH1_08V.Checked=true   then  begin REGOSC.calibreCH1:=0.8;Calibrech1scrollbar.position:=5; end;
  if CALIBCH1_04V.Checked=true   then  begin REGOSC.calibreCH1:=0.4;Calibrech1scrollbar.position:=6; end;
  if CALIBCH1_02V.Checked=true   then  begin REGOSC.calibreCH1:=0.2;Calibrech1scrollbar.position:=7; end;
  if CALIBCH1_0225V.Checked=true then  begin REGOSC.calibreCH1:=0.2;Calibrech1scrollbar.position:=8; end;
  if CALIBCH1_0215V.Checked=true then  begin REGOSC.calibreCH1:=0.2;Calibrech1scrollbar.position:=9; end;
  if CALIBCH1_0210V.Checked=true then  begin REGOSC.calibreCH1:=0.2;Calibrech1scrollbar.position:=10;end;

   SetSensitivity ( lCh1 , @REGOSC.calibreCH1 ) ;  // Calibre voie 1 : 0.2V . Attention passage par adresse.

  if CALIBreCH2_20V.Checked=true   then  begin REGOSC.calibreCH2:=20; Calibrech2scrollbar.position:=1; end;
  if CALIBreCH2_8V.Checked=true    then  begin REGOSC.calibreCH2:=8;  Calibrech2scrollbar.position:=2; end;
  if CALIBreCH2_4V.Checked=true    then  begin REGOSC.calibreCH2:=4;  Calibrech2scrollbar.position:=3; end;
  if CALIBreCH2_2V.Checked=true    then  begin REGOSC.calibreCH2:=2;  Calibrech2scrollbar.position:=4; end;
  if CALIBreCH2_08V.Checked=true   then  begin REGOSC.calibreCH2:=0.8;Calibrech2scrollbar.position:=5; end;
  if CALIBreCH2_04V.Checked=true   then  begin REGOSC.calibreCH2:=0.4;Calibrech2scrollbar.position:=6; end;
  if CALIBreCH2_02V.Checked=true   then  begin REGOSC.calibreCH2:=0.2;Calibrech2scrollbar.position:=7; end;
  if CALIBreCH2_0225V.Checked=true then  begin REGOSC.calibreCH2:=0.2;Calibrech2scrollbar.position:=8; end;
  if CALIBreCH2_0215V.Checked=true then  begin REGOSC.calibreCH2:=0.2;Calibrech2scrollbar.position:=9; end;
  if CALIBreCH2_0210V.Checked=true then  begin REGOSC.calibreCH2:=0.2;Calibrech2scrollbar.position:=10;end;
...
begin
    if Calibrech1scrollbar.position=1 then CALIBCH1_20V.Checked:=true;
    ...
    if Calibrech1scrollbar.position=8 then CALIBCH1_0225V.Checked:=true;   //calibre artificiel
    if Calibrech1scrollbar.position=9 then CALIBCH1_0215V.Checked:=true;   //calibre artificiel
    if Calibrech1scrollbar.position=10 then CALIBCH1_0210V.Checked:=true;  //calibre artificiel
...
begin
    if Calibrech2scrollbar.position=1 then CalibreCH2_20V.Checked:=true;
    ...
    if Calibrech2scrollbar.position=8 then CalibreCH2_0225V.Checked:=true;
    if Calibrech2scrollbar.position=9 then CalibreCH2_0215V.Checked:=true;
    if Calibrech2scrollbar.position=10 then CalibreCH2_0210V.Checked:=true;
...
procedure TOscilloCaba.TrigLevelBoxChange(Sender: TObject);
var level : double;
    voietrig : byte;
    calibretrig : double;
...
begin
  ...
  if voietrig=0 then GetSensitivity( lCh1, @Calibretrig);
  if voietrig=1 then GetSensitivity( lCh2, @Calibretrig);
