...
type
  TFormOscilloGTI2TransfertRegressiUtilisateur = class(TForm)
    ...
    procedure TRANSMultiALL(Sender: TObject);
    ...
    procedure EnvoieDonneesGTI_Enreg_Mono_ALL;
...
var
  FormOscilloGTI2TransfertRegressiUtilisateur: TFormOscilloGTI2TransfertRegressiUtilisateur;
...
uses  UnitOscilloGTI2{,regressispecdecl}{,Demodde},UnitTransfertRegressi,clipbrd;    //permet la liason avec les varaibles de principal
{$R *.dfm}

procedure TFormOscilloGTI2TransfertRegressiUtilisateur.FormCreate(Sender: TObject);
begin
    FormOscilloGTI2TransfertRegressiUtilisateur.Top:=0;
    FormOscilloGTI2TransfertRegressiUtilisateur.Left:=0;
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.ScrollBarINSTChange(Sender: TObject);
begin
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.FormShow(Sender: TObject);
var
i:integer;
begin
    ...
    if UnitOscilloGTI2.courbes[1].Valide  = true then begin GroupBoxEnrg1.Visible:=true; CheckBoxEnregistrement1.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[1].long_ech) +' pts' end;
    if UnitOscilloGTI2.courbes[2].Valide  = true then begin GroupBoxEnrg2.Visible:=true; CheckBoxEnregistrement2.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[2].long_ech) +' pts' end;
    if UnitOscilloGTI2.courbes[3].Valide  = true then begin GroupBoxEnrg3.Visible:=true; CheckBoxEnregistrement3.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[3].long_ech) +' pts' end;
    if UnitOscilloGTI2.courbes[4].Valide  = true then begin GroupBoxEnrg4.Visible:=true; CheckBoxEnregistrement4.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[4].long_ech) +' pts' end;
    if UnitOscilloGTI2.courbes[5].Valide  = true then begin GroupBoxEnrg5.Visible:=true; CheckBoxEnregistrement5.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[5].long_ech) +' pts' end;
    if UnitOscilloGTI2.courbes[6].Valide  = true then begin GroupBoxEnrg6.Visible:=true; CheckBoxEnregistrement6.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[6].long_ech) +' pts' end;
    if UnitOscilloGTI2.courbes[7].Valide  = true then begin GroupBoxEnrg7.Visible:=true; CheckBoxEnregistrement7.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[7].long_ech) +' pts' end;
    if UnitOscilloGTI2.courbes[8].Valide  = true then begin GroupBoxEnrg8.Visible:=true; CheckBoxEnregistrement8.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[8].long_ech) +' pts' end;
    if UnitOscilloGTI2.courbes[9].Valide  = true then begin GroupBoxEnrg9.Visible:=true; CheckBoxEnregistrement9.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[9].long_ech) +' pts' end;
    if UnitOscilloGTI2.courbes[10].Valide = true then begin GroupBoxEnrg10.Visible:=true; CheckBoxEnregistrement10.caption:='Nb de points dispo. : '+floattostr(UnitOscilloGTI2.courbes[10].long_ech) +' pts' end;

    if UnitOscilloGTI2.courbes[1].Valide  = true then begin  CheckBox1.Visible:=true end;
    if UnitOscilloGTI2.courbes[2].Valide  = true then begin  CheckBox2.Visible:=true end;
    if UnitOscilloGTI2.courbes[3].Valide  = true then begin  CheckBox3.Visible:=true end;
    if UnitOscilloGTI2.courbes[4].Valide  = true then begin  CheckBox4.Visible:=true end;
    if UnitOscilloGTI2.courbes[5].Valide  = true then begin  CheckBox5.Visible:=true end;
    if UnitOscilloGTI2.courbes[6].Valide  = true then begin  CheckBox6.Visible:=true end;
    if UnitOscilloGTI2.courbes[7].Valide  = true then begin  CheckBox7.Visible:=true end;
    if UnitOscilloGTI2.courbes[8].Valide  = true then begin  CheckBox8.Visible:=true end;
    if UnitOscilloGTI2.courbes[9].Valide  = true then begin  CheckBox9.Visible:=true end;
    if UnitOscilloGTI2.courbes[10].Valide = true then begin  CheckBox10.Visible:=true end;



end;

procedure TFormOscilloGTI2TransfertRegressiUtilisateur.ButtonTransfertClick(Sender: TObject);
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.EnvoieDonneesGTI_div( diviseur:integer;ch1,ch2,ch3,ch4:boolean );
var i : integer;
    ligne : string;
    BouLigne : string;
    zero,coeff : single;
...
begin
     ...
     if congiguration.Unipolaire[1]=true then TexteY1:='Y0' else TexteY1:='YD0' ;
     if congiguration.Unipolaire[2]=true then TexteY2:='Y1' else TexteY2:='YD1' ;
     if congiguration.Unipolaire[3]=true then TexteY3:='Y2' else TexteY3:='YD2' ;
     if congiguration.Unipolaire[4]=true then TexteY4:='Y3' else TexteY4:='YD3' ;
     ...
     if ch3 then ligne :=ligne +crTab+ TexteY3;
     if ch4 then ligne :=ligne +crTab+ TexteY4;
     Add(ligne);
     ...
     for i:=0 to (round(Recordlength/diviseur)-1) do
       begin
            ligne :=FloatToStr(i/freq);
                    ...
                    if ch3 then ligne :=ligne +crTab+FloatToStr(Ch3DoubleArray [i*diviseur]);
                    if ch4 then ligne :=ligne +crTab+FloatToStr(Ch4DoubleArray [i*diviseur]);
            Add(ligne);
       end;
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.TRANSMulti(Sender: TObject);
var chemin_windows         : array[0..255] of Char;
    chemin                : shortstring;
    t,v1,v2               : double;
    fichier                : textfile;
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.TRANSMultiALL(Sender: TObject);
var i,j:integer;
...
begin
 ...
 begin
     for j:=1 to nb_courbes_stockees do
     begin
          cochages[j].Checked:=true;
          Pourcent[j,4].Checked:=true;
     end;
     TRANSMulti(Sender);
 end;
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.EnvoieDonneesGTI_Enreg_Multi(NoEnrg:integer;diviseur:integer;ALL,Ch1,Ch2,Ch3,Ch4:boolean);
var i,j,k : integer;
    ligne : string;
    BouLigne : string;
    freq:dword;
...
const
    ...
    SymbReg2 = '&';
begin
     if courbes[NoEnrg].Unipol_Y1=true then TexteY1:='Y0' else TexteY1:='YD0' ;
     if courbes[NoEnrg].Unipol_Y2=true then TexteY2:='Y1' else TexteY2:='YD1' ;
     if courbes[NoEnrg].Unipol_Y3=true then TexteY3:='Y2' else TexteY3:='YD2' ;
     if courbes[NoEnrg].Unipol_Y4=true then TexteY4:='Y3' else TexteY4:='YD3' ;
...
k:=0;
     ...
     if ALL then
     begin
          //ligne := 't'+crTab+'Y1'+crTab+'Y2'+crTab+'Y3'+crTab+'Y4';
          ligne := 't'+crTab+ TexteY1 +crTab+ TexteY2 +crTab+ TexteY3 +crTab+ TexteY4;
          Add(ligne);
          ligne := 's'+crTab+'V'+crTab+'V'+crTab+'V'+crTab+'V';
          Add(ligne);

          if courbes[NoEnrg].PreTrig=false then
              begin
          ...
          else      //  if courbes[NoEnrg].PreTrig=false
              begin
              for i:=0 to round((courbes[NoEnrg].long_ech-500)/diviseur)-1 do
                begin
                ligne :=FloatToStr((diviseur*i-courbes[NoEnrg].PointTrig)/courbes[NoEnrg].freq_ech);
                ligne :=ligne +crTab+FloatToStr(courbes[NoEnrg].voie1 [i*diviseur]);
                ligne :=ligne +crTab+FloatToStr(courbes[NoEnrg].voie2 [i*diviseur]);
                ligne :=ligne +crTab+FloatToStr(courbes[NoEnrg].voie3 [i*diviseur]);
                ligne :=ligne +crTab+FloatToStr(courbes[NoEnrg].voie4 [i*diviseur]);
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.ButtonMONOClick(Sender: TObject);
begin
     EnvoieDonneesGTI_Enreg_Mono(1);
end;

procedure TFormOscilloGTI2TransfertRegressiUtilisateur.EnvoieDonneesGTI_Enreg_Mono(diviseur:integer);
var i,j,k : integer;
    ligne : string;
    ligne2: string;
    BouLigne : string;
...
begin
     ...
     begin
          ...
          if courbes[NoEnrg].Unipol_Y1=true then TexteY1:='Y0E' else TexteY1:='YD0E' ;
          if courbes[NoEnrg].Unipol_Y2=true then TexteY2:='Y1E' else TexteY2:='YD1E' ;
          if courbes[NoEnrg].Unipol_Y3=true then TexteY3:='Y2E' else TexteY3:='YD2E' ;
          if courbes[NoEnrg].Unipol_Y4=true then TexteY4:='Y3E' else TexteY4:='YD3E' ;
          ...
          begin
              ...
              begin
                  ...
                  ligne :=ligne+crTab +TexteY1+inttostr(NoEnrg) +crTab +TexteY2+inttostr(NoEnrg) +crTab +TexteY3+inttostr(NoEnrg) +crTab +TexteY4+inttostr(NoEnrg);
              ...
              begin
                  ...
                  if courbes[NoEnrg].Tmode[3] then ligne :=ligne +crTab+TexteY3+inttostr(NoEnrg);
                  if courbes[NoEnrg].Tmode[4] then ligne :=ligne +crTab+TexteY4+inttostr(NoEnrg);
     ...
     begin
          if cochagesMONO[NoEnrg].Checked=true then  k:=NoEnrg;    //pb de la base de temps : on prend la dernière
     end;
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.EnvoieDonneesGTI_Enreg_Mono_ALL;
var i,j:integer;
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.DeblocageTransfertMONO(Sender: TObject);
begin
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.DeblocageTransfertMULTI(Sender: TObject);
begin
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.GroupBoxMultiMouseMove(Sender: TObject;
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.EcranNoir (sender: Tpaintbox);
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.ResetEcranEnregistrement (sender: Tpaintbox);
var
X,Y,t:integer;
begin
// effaçage
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.affichageEnregistrement(Sender: Tpaintbox;CH:integer;NumEnrg:integer);
...
procedure TFormOscilloGTI2TransfertRegressiUtilisateur.FormClose(
  Sender: TObject; var Action: TCloseAction);
begin
     FormOscilloGTI2.MenuRegUtilisateurClick_RETOUR(Sender);
end;
