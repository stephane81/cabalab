...
const CabalabCube = true;     // True = Cabalab3 // False = Cabalab
      //Version = 'LGT CABANIS BRIVE';
     Version = '1.9.79';
      DateVersion = '16 Oct. 2007';
...
uses  {Unit1MesuresCaba}Unit1MesuresCaba_HS3, Unit_Traceur_HS3{Unit1CabaGraph}, unitOscilloHS3{principalOscilloCaba} , UnitGBF,
  UnitBodePrincipal, UnitTITvoiture, spectrumFFT, UnitFantome, UnitAPropos,
  Unit1CheminScilab ;
...
erreur:=InitInstrument($308);
   ...
   LabelConnexion2.Caption := 'Vérifier que l''appareil est bien relié au port USB puis cliquer sur le bouton pour connecter l''interface TiePie HS3 à CabaLab3';
   NilAllProcAddresses;
   ...
   LabelConnexion2.Caption := 'L''interface TiePie HS3 est connectée et fonctionne correctement.';
...
erreur:=InitInstrument($308);
   ...
   begin
   // Ecrire ici les actions en cas d'absence du module
   LabelConnexion2.Caption := 'Vérifier que l''appareil est bien relié au port USB puis cliquer sur le bouton pour connecter l''interface GTI2 à CabaLab3';
   NilAllProcAddresses;
   SpeedButtonConnexion.Down:=false; // Active le bouton Tiepie
   AppareilConnecteUSB:=false;
   end
   ...
   LabelConnexion.Font.Color := clGreen ;
   LabelConnexion.Caption := 'Appareil Connecté';
   LabelConnexion2.Caption := 'L''interface GTI2 est connectée et fonctionne correctement.';
...
Form1MesuresCaba_HS3.visible:=true;
Form1MesuresCaba_HS3.WindowState:=wsNormal;  // met la fenetre en taille normale (au cas ou elle est iconifiée)
Form1MesuresCaba_HS3.BringToFront; // met la fenetre au premier plan
...
Form_Traceur_HS3.visible:=true;
Form_Traceur_HS3.WindowState:=wsNormal;  // met la fenetre en taille normale (au cas ou elle est iconifiée)
Form_Traceur_HS3.BringToFront; // met la fenetre au premier plan
...
Fenetre_Spectre.visible:=true;
Fenetre_Spectre.WindowState:=wsNormal;    // met la fenetre en taille normale (au cas ou elle est iconifiée)
Fenetre_Spectre.BringToFront; // met la fenetre au premier plan
